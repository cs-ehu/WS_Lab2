<header class='main' id='h1'>
		<div id="logIn">
			<?php if( isset($_GET['usuario']) && isset($_GET['foto']) && isset($_GET['email']) && isset($_GET['contadorUsuarios']) && $_SESSION['email'] && ($_SESSION['rol'] == 'admin' || $_SESSION['rol'] == 'alumno') ){
				$email = $_GET['email'];
				?>
...
<?php }?>
	...
	<nav class='main' id='n1' role='navigation'>
		<?php if( isset($_GET['usuario']) && isset($_GET['foto']) && isset($_GET['email']) && isset($_GET['contadorUsuarios']) && $_SESSION['email'] && $_SESSION['rol'] != 'admin'){
			$email = $_GET['email'];
	...
	<?php }else if( isset($_GET['usuario']) && isset($_GET['foto']) && isset($_GET['email']) && isset($_GET['contadorUsuarios']) && $_SESSION['email'] && $_SESSION['rol'] != 'alumno'){
			$email = $_GET['email'];
			$usuario = $_GET['usuario'];
			$foto = $_GET['foto'];
			$contadorUsuarios = $_GET['contadorUsuarios'];
		...
		?>
		<span><a href='layout.php?email=<?php echo $email;?>&usuario=<?php echo $usuario;?>&foto=<?php echo $foto;?>&contadorUsuarios=<?php echo $contadorUsuarios;?>'>Inicio</a></span><br/><br/>
		<span><a href='GestionarCuentas.php?email=<?php echo $email;?>&usuario=<?php echo $usuario;?>&foto=<?php echo $foto;?>&contadorUsuarios=<?php echo $contadorUsuarios;?>'>Gestionar cuentas</a></span><br/><br/>
		<span><a href='creditos.php?email=<?php echo $email;?>&usuario=<?php echo '"'.$usuario.'"';?>&foto=<?php echo $foto;?>&contadorUsuarios=<?php echo $contadorUsuarios;?>'>Creditos</a></span>
	<?php }else{?>
